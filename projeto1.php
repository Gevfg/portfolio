...
?>
    ...
    <section id="projetos">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img class="img-responsive projeto" src="img/portfolio/1.jpg">
                </div>
                <div class="col-md-6">
                    <h3>Como foi feito:</h3>
                    <p> Este trabalho foi feito seguindo as normas internas de desenvolvimento, visando necessariamente os conceitos mais basicos do mundo web, sem dúvidas é algo a se pensar, e se estudar, podemos levar em conta varias coisas como por exemplo o exesso de confiança entre outros, porem é algo assim que precisamos. teste </p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="next">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a class="btn btn-proj"><i class="fa fa-arrow-left"></i></a>
                        <a class="btn bt-proj" href="projeto2.php"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
