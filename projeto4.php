...
?>
    ...
    <section id="projetos">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img class="img-responsive projeto" src="img/portfolio/4.jpg">
                </div>
                <div class="col-md-6">
            ...
            <div class="next">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a class="btn btn-proj" href="projeto3.php"><i class="fa fa-arrow-left"></i></a>
                        <a class="btn bt-proj" href="projeto5.php"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
