...
?>
    ...
    <section id="projetos">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img class="img-responsive projeto" src="img/portfolio/5.jpg">
                </div>
                <div class="col-md-6">
            ...
            <div class="next">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a class="btn btn-proj" href="projeto4.php"><i class="fa fa-arrow-left"></i></a>
                        <a class="btn bt-proj" href="projeto6.php"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
