...
?>
    ...
    <section id="projetos">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <img class="img-responsive projeto" src="img/portfolio/6.jpg">
                </div>
                <div class="col-md-6">
            ...
            <div class="next">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <a class="btn btn-proj" href="projeto5.php"><i class="fa fa-arrow-left"></i></a>
                        <a class="btn bt-proj over"><i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
